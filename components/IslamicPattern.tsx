  ...
  return (
    <Svg width={size} height={size} viewBox={`0 0 ${size} ${size}`}>
      <G>
        ...
        <Circle cx={center} cy={center} r={size * 0.08} fill={color} opacity={opacity * 1.5} />
      </G>
    </Svg>
  );
};
...
export const AyahSeparator: React.FC<{ color?: string; width?: number }> = ({
  ...
  return (
    <View style={[styles.separatorContainer, { width, alignSelf: 'center' }]}>
      <View style={{ flex: 1, height: lineHeight, backgroundColor: color, opacity: 0.2 }} />
