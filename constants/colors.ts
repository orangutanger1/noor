...
export default {
  light: {
    ...
    // Gold Accent (muted tones)
    gold: '#B8860B',              // Muted gold
    goldLight: '#DAA520',         // Lighter muted gold
    goldSoft: '#F0E68C',          // Soft khaki gold
    goldMuted: '#FEF3C7',         // Whisper of gold for backgrounds

    // Surface Colors
    background: '#FFFEF9',        // Warm cream
    surface: '#FFFFFF',           // Pure white surface
    surfaceElevated: '#FFFFFF',   // Pure white for elevated cards
    surfaceSubdued: '#F5F0E6',    // Subtle depth for sections

    // Text Hierarchy
    text: '#2D2A26',              // Rich charcoal
    textSecondary: '#5C5650',     // Muted charcoal
    ...
    // Borders & Dividers
    border: '#E5E2DD',            // Subtle warm gray border
    borderLight: '#F0EDE8',       // Very subtle border
    borderAccent: '#B8860B',      // Gold accent border
...
// Shadows (iOS) - reduced opacity for minimal design
